...
public class Home {
    ...
    public Boolean searchForProduct(String product) {
        try {
            ...
            // box
            WebElement searchBox = driver.findElement(By.xpath("//div[@class='MuiFormControl-root MuiTextField-root search-desktop css-i44wyl']//descendant::input"));
            searchBox.clear();
            searchBox.sendKeys(product);
            // TODO: CRIO_TASK_MODULE_XPATH - M0 Fix broken Xpath
            WebDriverWait wait = new WebDriverWait(driver,30);
            Thread.sleep(3000);
            //wait.until(ExpectedConditions.or(ExpectedConditions.textToBePresentInElement(text, product)),ExpectedConditions.presenceOfElementLocated(By.xpath("//h4[text()=' No products found ']")));
            wait.until(ExpectedConditions.or(ExpectedConditions.textToBePresentInElementLocated(By.xpath("//*[@id='root']/div/div/div[3]/div/div[2]/div/div/div[1]/p[1]"), product),
            ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id='root']/div/div/div[3]/div/div[2]/div/h4"))));
            Thread.sleep(3000);
            return true;
        } catch (Exception e) {
