...
public class QkartSanity {
    ...
    public static Boolean TestCase01(RemoteWebDriver driver) throws InterruptedException {
        ...
        takeScreenshot(driver,"_StartTestCase", "_TestCase01");
        status = registration.registerUser("testUser", "abc@123", true);
        takeScreenshot(driver,"_EndTestCase", "_TestCase01");
        if (!status) {
            ...
            takeScreenshot(driver,"_TestCaseFailed", "_TestCase01");
    ...
    public static Boolean TestCase02(RemoteWebDriver driver) throws InterruptedException {
        ...
        registration.navigateToRegisterPage();
        status = registration.registerUser("testUser", "abc@123", true);
        takeScreenshot(driver,"_StartTestCase", "_TestCase02");
        ...
        takeScreenshot(driver,"_EndTestCase", "_TestCase02");
    ...
    public static Boolean TestCase03(RemoteWebDriver driver) throws InterruptedException {
        ...
        takeScreenshot(driver,"_StartTestCase", "_TestCase03");
        if (!status) {
        ...
        takeScreenshot(driver,"_EndTestCase", "_TestCase03");
        // SLEEP_STMT_02
        Thread.sleep(2000);

        // Search for product
        status = homePage.searchForProduct("Gesundheit");
        takeScreenshot(driver,"_StartTestCase_NoResults", "_TestCase03");
        if (!status) {
            logStatus("TestCase 3", "Test Case Failure. Unable to search for given product", "FAIL");
            return false;
        }
    ...
    public static Boolean TestCase04(RemoteWebDriver driver) throws InterruptedException {
        ...
        for (WebElement webElement : searchResults) {
            ...
            if (result.verifySizeChartExists()) {
                takeScreenshot(driver,"_StartTestCase", "_TestCase04");
                ...
                if (result.openSizechart()) {
                    ...
                    takeScreenshot(driver,"_EndTestCase", "_TestCase04");

                } else {
                    logStatus("TestCase 4", "Test Case Fail. Failure to open Size Chart", "FAIL");
                    takeScreenshot(driver,"_TestCaseFailure", "_TestCase04");
                    return false;
                }
    ...
    public static Boolean TestCase05(RemoteWebDriver driver) throws InterruptedException {
        ...
        if (!status) {
            ...
            takeScreenshot(driver,"_TestCaseFailure", "_TestCase05");
        }
        ...
        takeScreenshot(driver,"_StartTestCase", "_TestCase05");
        ...
        takeScreenshot(driver,"_EndTestCase", "_TestCase05");
    ...
    public static Boolean TestCase06(RemoteWebDriver driver) throws InterruptedException {
        ...
        takeScreenshot(driver,"_StartTestCase", "_TestCase06");
        ...
        takeScreenshot(driver,"_EndTestCase", "_TestCase06");
    ...
    public static Boolean TestCase07(RemoteWebDriver driver) throws InterruptedException {
        ...
        takeScreenshot(driver,"_StartTestCase", "_TestCase07");
        ...
        takeScreenshot(driver,"_EndTestCase", "_TestCase07");
    ...
    public static Boolean TestCase11(RemoteWebDriver driver) throws InterruptedException {
        Boolean status;
        logStatus("Start TestCase",
                "Test Case 11: Verify that ads are displayed on thanks page",
                "DONE");
        ...
        System.out.println("total number of iframes is : "+ iframesCount.size());
        driver.switchTo().frame(0);
        List<WebElement> buttons = driver.findElements(By.xpath("//*[@id='continue-btn']"));
        for (int i=1;i<=buttons.size();i++) {
            driver.findElement(By.xpath("/html/body/div/div/div/div/div/div/button["+i+"]")).click();
        ...
        List<WebElement> buttonsonI2 = driver.findElements(By.xpath("//*[@id='continue-btn']"));
        for (int i=1;i<=buttonsonI2.size();i++) {
            driver.findElement(By.xpath("/html/body/div/div/div/div/div/div/button["+i+"]")).click();
            driver.navigate().back();
            driver.switchTo().frame(1);
        }
    ...
    public static Boolean TestCase08(RemoteWebDriver driver) throws InterruptedException {
        ...
        Boolean status;
        logStatus("Start TestCase",
                "Test Case 09: Verify that products in the cart should be present in the new tab",
                "DONE");
        ...
        for(String x:windowsTab) {
            if(!mainWindowHandler.equals(x)){
        ...
        logStatus("End TestCase", "Test Case 9: Verify Cart Contents : ", status ? "PASS" : "FAIL");
        takeScreenshot(driver, "home page", "EndTestCase09_screenshot");
        return status;
    }
    ...
    public static Boolean TestCase09(RemoteWebDriver driver) throws InterruptedException {
        Boolean status = false;
        // TODO: CRIO_TASK_MODULE_SYNCHRONISATION -
        String URL1="https://crio-qkart-frontend-qa.vercel.app/";
        driver.get(URL1);
        String mainWindowHandler = driver.getWindowHandle();
        driver.findElement(By.xpath("//*[@id='root']/div/div/div[5]/div[2]/p[1]/a")).click();
        Home homepage = new Home(driver);
        status=homepage.URLOnClick(URL1);
        logStatus("Start TestCase", "Test Case 10: Verify URL : ", status ? "PASS" : "FAIL");
        Set<String> windowsTab=driver.getWindowHandles();
        for(String x:windowsTab) {
            if(!mainWindowHandler.equals(x)){
                driver.switchTo().window(x);
        ...
        String URL2="https://crio-qkart-frontend-qa.vercel.app/privacy-policy";
        homepage.URLOnClick(URL2);
        driver.switchTo().window(mainWindowHandler);
        driver.findElement(By.xpath("//*[@id='root']/div/div/div[5]/div[2]/p[4]/a")).click();
        windowsTab=driver.getWindowHandles();
        for(String x:windowsTab) {
            if(!(mainWindowHandler.equals(x) && secondwindow.equals(x))){
                driver.switchTo().window(x);
            }
        }
        String URL3="https://crio-qkart-frontend-qa.vercel.app/terms-of-service";
        status=homepage.URLOnClick(URL3);
        logStatus("Start TestCase", "Test Case 10: Verify URL : ", status ? "PASS" : "FAIL");

        windowsTab=driver.getWindowHandles();
        for(String x:windowsTab) {
            if(!x.equals(mainWindowHandler)){
    ...
    public static Boolean TestCase10(RemoteWebDriver driver) throws InterruptedException {
        ...
        WebElement submit= driver.findElement(By.xpath("/html/body/div[2]/div[3]/div/section/div/div/div/form/div/div/div[4]/div/button"));
        submit.click();
        WebDriverWait wait = new WebDriverWait(driver,10);
        if(wait.until(ExpectedConditions.invisibilityOf(submit))){
